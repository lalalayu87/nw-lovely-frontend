...
import { qSheet } from './UserNewQSheetHeader'
...
function _UserQSheetDataTable<T>(
...
const UserQSheetDataTable = forwardRef(_UserQSheetDataTable) as <T>(
    props: DataTableProps<T> & {
        ref?: ForwardedRef<DataTableResetHandle>
    }
) => ReturnType<typeof _UserQSheetDataTable>

export type { ColumnDef, Row, CellContext }
export default UserQSheetDataTable
