...
const CueSheetDataTable = forwardRef(_CueSheetDataTable) as <T>(
    props: DataTableProps<T> & {
        ref?: ForwardedRef<DataTableResetHandle>
    }
) => ReturnType<typeof _CueSheetDataTable>

export type { ColumnDef, Row, CellContext }
export default CueSheetDataTable
