...
import { qSheet } from './NewQSheetHeader'
...
const QSheetDataTable = forwardRef(_QSheetDataTable) as <T>(
    props: DataTableProps<T> & {
        ref?: ForwardedRef<DataTableResetHandle>
    }
) => ReturnType<typeof _QSheetDataTable>

export type { ColumnDef, Row, CellContext }
export default QSheetDataTable
